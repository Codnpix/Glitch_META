...
{
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,4,-31,144,7},
  {Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,44,2,-127,268,17},
  {Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,63,0,49,535,2},
  {Gamebuino_Meta::Sound_FX_Wave::NOISE,0,28,0,-48,160,2},
};
...
{
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,13,70,112,11},
	...
	{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,30,0,0,378,0},
	{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,75,0,0,126,2},
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,0,0,0,0,0,0},
};

const Gamebuino_Meta::Sound_FX drop_frag2_ctnr_fx[] =
{
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,6,70,112,11},
...
{
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,5,70,112,11},
...
{
	{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,5,73,64,10},
	...
	//{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,64,0,0,113,1},
	//{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,75,0,0,126,0},
	//{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,75,0,0,126,2},
	//{Gamebuino_Meta::Sound_FX_Wave::NOISE,0,0,0,0,0,0},
  //{Gamebuino_Meta::Sound_FX_Wave::NOISE,1,65,82,87,48,21},
  //{Gamebuino_Meta::Sound_FX_Wave::SQUARE,1,54,71,-128,477,6},
  {Gamebuino_Meta::Sound_FX_Wave::NOISE,1,0,39,-20,176,50},
